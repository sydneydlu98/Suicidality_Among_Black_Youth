...
```{r, warning=FALSE}
summary(svyglm(QN29 ~ QN69 + QN99 + QN43 + QN54, data = suicide_attempt, design = yrbsdes_subgroup, family = quasibinomial()))
# QN69: Did not drink fruit juice 
# QN99: How well do you speak English?        
# QN43: During the past 30 days, what is the largest number of alcoholic drinks you had in a row, that is, within a couple of hours? (Binary: Reported that the largest number of drinks they had in a row was 10 or more)      
